...
#
#     PHX_SERVER=true bin/microservice_app start
#
...
if config_env() == :prod do
  ...
  config :microservice_app, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :microservice_app, MicroserviceApp.Mailer,
